...
fun main() {
    ...
    val expected3 = "a25de9b5-4320-3585-a53c-ef5ede492fed"
    val expected5 = "1730930d-a36a-5efd-aa3f-561a164f87a4"
    val actual3 = uuid3(Namespace.URL, url)
    val actual5 = uuid5(Namespace.URL, url)

    println("URL: $url")
    println()
    println("EXP3: $expected3")
    println("ACT3: $actual3")
    println()
    println("EXP5: $expected5")
    println("ACT5: $actual5")
}
