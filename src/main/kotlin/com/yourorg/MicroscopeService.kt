...
class MicroscopeService {
    ...
    fun analyzeMethodInvocation(
        ...
        if (methodInvocation.methodType != null && relevantReceiverType) {
            ...
            val individualCallee = model.createIndividual(
    ...
    private fun classifyMethod(jMethodDeclaration: J.MethodDeclaration, cursor: Cursor, individualMethod: OntIndividual) {
        ...
        methodClassifiers.forEach {
            it.classify(individualMethod, cursor, jMethodDeclaration)
        }
    }
}
